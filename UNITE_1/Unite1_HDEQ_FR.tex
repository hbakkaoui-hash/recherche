...
\emph{fig\'e} par constituant, le d\'ephasage par constituant cro\^it lin\'eairement en $T$,
d'o\`u une variance \emph{quadratique}
\[
...
de cycle en cycle (processus stochastique), la variance devient \emph{lin\'eaire} en
$T$,
\[
...
$\lvert A_\psi(t)\rvert^2=1-(\Delta H_{\mathrm{eff}}/\hbar)^2 t^2+O(t^4)$, avec
...
r\'esultats est prise comme postulat heuristique.
...
\begin{itemize}
\item $\tau_0$ et $\varepsilon$ sont ph\'enom\'enologiques, non d\'eriv\'es de premiers principes (une origine g\'eom\'etrique est conjectur\'ee, cf.\ conclusion).
...
\item La s\'election d'une branche unique n'est pas r\'esolue ; la r\`egle de Born est heuristique.
\item Le secteur spectroscopique est non discriminant sous la prescription consistante (B).
\end{itemize}

\subsection{Origine de $\varepsilon$ et $\tau_0$ : une direction g\'eom\'etrique}
